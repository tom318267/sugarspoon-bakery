...
const Services = () => {
  ...
  return (
    <section className="services">
      <div className="flex flex-col items-center py-[7.063rem]">
        <h2 className="text-[3.5rem] text-white font-bold text-center playfair-display">
          Our Services
        </h2>
        ...
        >
          {services.map((service, index) => (
            <motion.div
              className="bg-white w-[24rem] h-[24.125rem] rounded"
              key={index}
              ...
              <div className="flex flex-col justify-center items-center p-6">
                ...
                <Link href={service.href}>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-accent w-[20.875rem] py-3 px-4 flex justify-center items-center rounded text-[1.125rem] montserrat-med hover:bg-[#D1775D] text-white btn-shadow"
                  >
                    Learn More
                  </motion.button>
                </Link>
